...
(ert-deftest t--get-datetime-format ()
  ...
  ($l (t--get-datetime-format 28800 's-none) "%F %R+0800")
  ($l (t--get-datetime-format 18000 's-none) "%F %R+0500")
  ($l (t--get-datetime-format -28800 's-none) "%F %R-0800")
  ($l (t--get-datetime-format -18000 's-none) "%F %R-0500")
  ($l (t--get-datetime-format 0 's-none) "%F %R+0000")
  ($l (t--get-datetime-format 0 's-none-zulu) "%F %RZ")
  ($l (t--get-datetime-format 0 's-colon) "%F %R+00:00")
  ($l (t--get-datetime-format 0 's-colon-zulu) "%F %RZ")
  ($l (t--get-datetime-format 4800 's-colon-zulu) "%F %R+01:20")
  ...
  ($l (t--get-datetime-format 3600 's-colon) "%F %R+01:00")
  ($l (t--get-datetime-format -900 's-colon) "%F %R-00:15")
  ($l (t--get-datetime-format 19800 'T-colon) "%FT%R+05:30")
  ($l (t--get-datetime-format -16200 'T-colon) "%FT%R-04:30")
  ($l (t--get-datetime-format 50400 's-none) "%F %R+1400")
  ($l (t--get-datetime-format -43200 's-none) "%F %R-1200")
  ($l (t--get-datetime-format 37800 'T-colon-zulu) "%FT%R+10:30")
  ($n (t--get-datetime-format 0 nil))
  ($l (t--get-datetime-format 'local nil t) "%F")
  ($l (t--get-datetime-format 'local 's-none) "%F %R")
  ($l (t--get-datetime-format 'local 's-none-zulu) "%F %R")
  ($l (t--get-datetime-format 'local 's-colon) "%F %R")
  ($l (t--get-datetime-format 'local 's-colon-zulu) "%F %R")
