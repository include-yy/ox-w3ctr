...
(defun t--oinfo-exists-p ()
  "Test if `org-w3ctr--oinfo' is defined.

This oclosure type and helper functions only exist in interpreted code."
  ;; (oclosure--class-p (get 'org-w3ctr--oinfo 'cl--class))
  (fboundp 't--make-cache-oclosure))

(defun t--oinfo-skip ()
  "Skip if `org-w3ctr--oinfo' is not defined."
  (unless (t--oinfo-exists-p)
    (ert-skip "`org-w3ctr--oinfo' not yet defined.")))
