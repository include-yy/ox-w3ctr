...
;; OINFO: a lightweight caching system for property lookups within the
...
on the keys listed in `org-w3ctr--oinfo-cache-props'. Each element is a
cons cell of the form (KEY . FUNCTION), where KEY is a property
